...
import { GallerySingleView } from '../gallery'
...
import applesImg from 'common/assets/images/apples.jpg'
import orangsImg from 'common/assets/images//oranges.jpg'
...
const additionalTermsData: {
  ...
  {
    documents: ['test.pdf'],
    images: [applesImg.src, orangsImg.src, kiwiImg.src],
  },
]

export const QuoteStep3: FC<QuoteStep3Props> = (props) => {
