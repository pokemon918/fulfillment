...
import safetyIcon from 'common/assets/images/safety-icon.svg'
import dollarIcon from 'common/assets/images/dollar-icon.svg'
import blockchainIcon from 'common/assets/images/blockchain-icon.svg'
...
const features = [
  ...
  {
    img: blockchainIcon.src,
    title: 'blockchain',
    desc: 'Real-time traceability recorded in the blockchain for all parties',
  },
]

export const QuoteFeatures: FC<QuoteFeaturesProps> = (props) => {
