    ...
    <>
      {isLoading?<>Loading...</>: <>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 xl:grid-cols-5 2xl:gap-7.5">
          {/* company */}
          <CardDataStats title="Total Companies" total={(companies.series.reduce((acc, curr) => acc + curr, 0)).toString()}>
            <svg
          ...
          {/* user */}
          <CardDataStats title="Total Users" total={(users.series.reduce((acc, curr) => acc + curr, 0)).toString()}>
            <svg
              className="fill-primary dark:fill-white"
              width="22"
              height="18"
          ...
          {/* contract */}
          <CardDataStats title="Total Contracts" total={(contracts.series.reduce((acc, curr) => acc + curr, 0)).toString()}>
            <svg
              className="fill-primary dark:fill-white"
              width="22"
              height="16"
          ...
          {/* product */}
          <CardDataStats title="Total Products" total={products.map(obj => obj.count).reduce((acc, curr) => acc + curr, 0).toString()}>
            <svg
              className="fill-primary dark:fill-white"
              width="20"
              height="22"
          ...
          {/* category */}
          <CardDataStats title="Total Categories" total={categories.toString()}>
