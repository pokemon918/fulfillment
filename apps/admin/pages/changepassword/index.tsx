...
const ChangePassword: React.FC = () => {
    ...
    const onSubmit = async (event: SyntheticEvent) => {
        ...
        const current_password = target.current_password.value;
        ...
        try {
            ...
            const {
              login: { token, user },
            } = await graphqlReq(LOGIN, { input })
            if (user?.role === 'admin') {
              await graphqlReq(BEGIN_RESET_PASSWORD, {
                email,
              ...
              toast('Plz input correct admin email or password!')
              return
            }
...
export default withAuth(ChangePassword, 'admin');
